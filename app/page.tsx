    ...
    <main className="h-screen overflow-y-auto overflow-x-hidden snap-y snap-mandatory scroll-smooth bg-background">
      ...
      <section id="proyectos" className="min-h-screen lg:h-screen w-full snap-start snap-always bg-primary text-primary-foreground flex items-center py-14 overflow-hidden">
        <div className="container px-6 mx-auto">
          <motion.h2 initial={{opacity:0}} whileInView={{opacity:1}} className="text-4xl sm:text-5xl font-bold sm:mb-8 sm:mt-2 mb-2 tracking-tighter">MIS PROYECTOS</motion.h2>
